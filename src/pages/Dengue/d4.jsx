        ...
        {!nivelConcluido && <>
          ...
          /> : <>
            <View style={{ flexDirection: "row" }}>
              <View style={{ width: "60%", marginTop: 30 }}>
                <ImageContent2 onTouchStart={() => selectedImage('doratrasdosolhos')} name={doratrasdosolhos} source={doratrasdosolhos} style={{ width: (imageSelected == "doratrasdosolhos" ? 85 : 75), height: (imageSelected == "doratrasdosolhos" ? 100 : 90), marginLeft: 15, marginTop: 10 }} resizeMode="contain" />
                <ImageContent2 onTouchStart={() => selectedImage('dormuscular')} name={dormuscular} source={dormuscular} style={{ width: (imageSelected == "dormuscular" ? 90 : 80), height: (imageSelected == "dormuscular" ? 100 : 90), marginLeft: 15, marginTop: 10 }} resizeMode="contain" />
                <ImageContent2 onTouchStart={() => selectedImage('dordecabeca')} name={dordecabeca} source={dordecabeca} style={{ width: (imageSelected == "dordecabeca" ? 90 : 80), height: (imageSelected == "dordecabeca" ? 100 : 90), marginLeft: 15, marginTop: 10 }} resizeMode="contain" />
                <ImageContent2 onTouchStart={() => selectedImage('nauseas')} name={nauseas} source={nauseas} style={{ width: (imageSelected == "nauseas" ? 90 : 80), height: (imageSelected == "nauseas" ? 100 : 90), marginLeft: 15, marginTop: 10 }} resizeMode="contain" />
              </View>
              <View>
              ...
              <View style={{ width: "40%", marginRight: 10 }}>
                <SubTitle3 onTouchStart={() => selectedSymptom('dormuscular')} name={dormuscular} style={{ width: "95%", fontSize: (textSelected == "dormuscular" ? 27 : 25), textDecorationLine: (textSelected == "dormuscular" ? 'underline' : 'none'), height: 90, marginTop: 30, paddingTop: 5, paddingBottom: 5, paddingRight: 10, textAlign: "right" }}>Dor muscular</SubTitle3>
                <SubTitle3 onTouchStart={() => selectedSymptom('doratrasdosolhos')} name={doratrasdosolhos} style={{ width: "95%", fontSize: (textSelected == "doratrasdosolhos" ? 27 : 25), textDecorationLine: (textSelected == "doratrasdosolhos" ? 'underline' : 'none'), height: 100, marginTop: 30, paddingTop: 5, paddingBottom: 5, paddingRight: 10, textAlign: "right" }}>Dor atrás dos olhos</SubTitle3>
                <SubTitle3 onTouchStart={() => selectedSymptom('nauseas')} name={nauseas} style={{ width: "95%", fontSize: (textSelected == "nauseas" ? 27 : 25), textDecorationLine: (textSelected == "nauseas" ? 'underline' : 'none'), height: 50, marginTop: 20, paddingTop: 5, paddingBottom: 5, paddingRight: 10, textAlign: "right" }}>Náuseas</SubTitle3>
                <SubTitle3 onTouchStart={() => selectedSymptom('dordecabeca')} name={dordecabeca} style={{ width: "95%", fontSize: (textSelected == "dordecabeca" ? 27 : 25), textDecorationLine: (textSelected == "dordecabeca" ? 'underline' : 'none'), height: 80, marginTop: 30, paddingTop: 5, paddingBottom: 5, paddingRight: 10, textAlign: "right" }}>Dor de cabeça</SubTitle3>
              </View>
            </View>
          </>}
          ...
          >
            <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginTop: -16, marginBottom: 16, }}>
              ...
              <TouchableOpacity style={{ borderRadius: 15, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 8, alignSelf: 'stretch', backgroundColor: '#C3272B', marginTop: 16, minWidth: '50%', paddingHorizontal: 16, }} onPress={() => { errosLocal >= 5 ? navigation.replace("Dengue") : setVisible(false)}}>
